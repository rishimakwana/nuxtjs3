                    ...
                    <div class="flex flex-col md:flex-row justify-between w-full">
                        <div class="flex flex-row justify-between items-start">
                            ...
                            <button onclick="showMenu(true)" class="ml-4 md:hidden">
                                <svg id="closeIcon" class="hidden" width="20" height="20" viewBox="0 0 20 20" fill="none"
                        ...
                        <div class="cursor-pointer mt-2 md:mt-0">
                            <svg class="dark:text-white" width="152" height="24" viewBox="0 0 152 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="flex flex-col md:flex-row flex justify-between w-full">
                            <div class="flex flex-row justify-between items-start">
                                ...
                                <button onclick="showMenu2(true)" class="ml-4 md:hidden">
                                    <svg id="closeIcon2" width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M15 12.5L10 7.5L5 12.5" stroke="currentColor" stroke-width="1.25"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                    <svg id="openIcon2" class="hidden" width="20" height="20" viewBox="0 0 20 20"
