        ...
        <div class="flex flex-col items-center justify-center px-6 py-6 mx-auto">
            ...
            <div class="w-full bg-white rounded-lg shadow sm:max-w-md xl:p-0 mb-8">
                <div class="space-y-4 md:space-y-6">
                    ...
                    <p class="px-6 text-sm text-gray-600">Don't have an account? Create your own <br /> account, it
                        takes
                    ...
                    <VeeForm class="space-y-4 md:space-y-6" :validation-schema="schema" :initial-values="initialValues"
                        ...
                        <div class="px-6">
                            <VTextInput type="text" name="phone" label="Phone number"
                                placeholder="Enter phone number" />
                        </div>
                        <div class="px-6">
                            <VTextInput type="email" name="email" label="Email address"
                        ...
                        <div class="flex items-start px-6">
                            ...
                            <div class="ml-3 text-sm">
                                <label for="terms" class="font-light text-gray-500">I accept the <a
                                        class="font-medium text-primary hover:underline" href="#">Terms and
                                        Conditions</a></label>
                            </div>
                        </div>
                        <div class="px-6">
                            <button type="submit"
                                class="w-full text-white bg-primary hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Create
                                an account</button>
                        </div>
