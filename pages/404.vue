            ...
            <div class="card">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-muted mb-0 mt-3" style="line-height: 20px;">It's looking like you may have taken a
                        ...
                        <nuxt-link to="/" class="btn btn-primary mt-3"><i class="mdi mdi-reply mr-1"></i> Return
                            Home</nuxt-link>
                    </div>
                </div>
            </div>
